...
#==============================================================================
        ...
        def generalized_propagator_operation(field_kwargs, K, sim, wavelength):
            ...
            if method.lower() == 'superlu':
                ...
                # print(mempool)
            elif method.lower() == 'arrayfire':
                import arrayfire as af

                print("ARRAYFIRE")

                E = af.solve_lu(K[0], K[1], E0_supervec)
...
# =============================================================================
    ...
    ## --- standard scipy.linalg inversion methods
    elif method.lower() in ["numpyinv", "scipyinv", "lu", "pinv2", "arrayfire"]:
        if method.lower() in ["numpyinv"]:     # pyGDM2 default
            ...
            print("LU K SHAPE: ", K.shape)
        elif method.lower() in ["arrayfire"]:
            import arrayfire as af
            ...
            L, U, P = af.lu(CAM0)
            K = L + U, P
            print("ARRAYFIRE K SHAPE: ", K.shape)
